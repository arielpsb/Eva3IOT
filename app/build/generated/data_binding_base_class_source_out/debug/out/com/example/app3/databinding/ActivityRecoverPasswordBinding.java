...
public final class ActivityRecoverPasswordBinding implements ViewBinding {
  ...
  private ActivityRecoverPasswordBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageButton btnBack, @NonNull Button btnRecuperar,
      @NonNull EditText etEmailRecuperar, @NonNull ImageView ivLogo) {
  ...
  public static ActivityRecoverPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRecoverPasswordBinding((ConstraintLayout) rootView, btnBack, btnRecuperar,
          etEmailRecuperar, ivLogo);
    }
